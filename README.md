...
- **Validation Performance**: 88.5% mAP@50. This honestly supports a **"Tested / Validated MVP"** status for the real classes. Fully documented with `results.csv`, PR curves, and confusion matrices in the `models` directory.
